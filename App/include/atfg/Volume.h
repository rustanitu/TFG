...
namespace vr
{
	...
	public:
		...
		glm::vec3 GetAnchorMin();
		glm::vec3 GetAnchorMax();
		void SetAnchors(glm::vec3 pmin, glm::vec3 pmax);
		...
		double InterpolatedValue(glm::vec3 pos);

		double TrilinearScalarFunction(glm::vec3 pos, glm::vec3 rayeye, glm::vec3 raydirection);
