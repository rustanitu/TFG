...
#ifndef LQC_SAMPLING_WEIGHTEDDISCRETEPDF_H
#define LQC_SAMPLING_WEIGHTEDDISCRETEPDF_H
...
namespace lqc
{
  ...
  public:
    ...
    void update (T item, float newWeight)
    {
      ...
      if (!n) {
        ...
        float delta = newWeight - n->weight;
        n->weight = newWeight;
  ...
  typedef WeightedDiscretePDF<int> WeightedDiscretePDFi;
}
