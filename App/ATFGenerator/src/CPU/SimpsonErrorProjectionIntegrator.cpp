...
bool SimpsonErrorProjectionIntegrator::ColorErrorEvalFunc (lqc::Vector4d a, lqc::Vector4d b, double tol)
{
  tol = 15.0 * tol;
...
lqc::Vector4d SimpsonErrorProjectionIntegrator::CalculateExternalError (double s, double h, double tol)
{
  lqc::Vector4d err (0);
  double a, d, c, e, b;
  a = s; b = s + h; c = (a + b) / 2.0;
...
lqc::Vector4d SimpsonErrorProjectionIntegrator::ExtenalEvaluation (double p_d, lqc::Vector4d C, double* pre_alpha)
{
  double alpha = 0.0;
...
lqc::Vector4d SimpsonErrorProjectionIntegrator::ExtenalEvaluationMiddle (double p_d, lqc::Vector4d C, lqc::Vector4d Cmid, double* pre_alpha)
{
  double alpha = 0.0;
  double h = p_d - minpost;
  if (h != 0)
...
lqc::Vector4d SimpsonErrorProjectionIntegrator::GetFromTransferFunction (double p_d)
{
  lqc::Vector4d ret;
