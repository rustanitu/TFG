/*!
\file   SimpsonErrorIntegrator.h
\brief  Simpson Integrator based on error value
\author Leonardo Quatrin Campagnolo
*/

#ifndef SIMPSON_ERROR_INTEGRATOR_H
#define SIMPSON_ERROR_INTEGRATOR_H
...
public:
  SimpsonErrorIntegrator (VolumeEvaluator* veva);
  ~SimpsonErrorIntegrator ();
