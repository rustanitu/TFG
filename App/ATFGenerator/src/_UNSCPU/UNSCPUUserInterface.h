...
#ifndef UNSCPUUSERINTERFACE_H
#define UNSCPUUSERINTERFACE_H
...
class UNSCPUUserInterface
{
public:
  static int ToggleCB_UseFunctionEvaluation (Ihandle* ih, int state);
  static int ListCB_FuncEvaluationChange (Ihandle* ih, char *text, int item, int state);
...
public:
  ...
  void SetUseFunctionEvaluation (bool use_function_evaluation);
  void SetAllFunctions (std::vector<std::string>);
...
private:
  Ihandle* m_iup_toggle_usefunctionevaluation;
  Ihandle* m_iup_list_functionevaluations;
