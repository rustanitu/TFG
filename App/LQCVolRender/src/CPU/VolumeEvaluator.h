...
public:
  ...
  */
  bool EvaluateIntegral (glm::dvec4 *returncolor, vr::Volume *volume,
                         glm::vec3 minpos, glm::vec3 maxpos, void* data = NULL);
  ...
  */
  float GetValueFromVolume (vr::Volume* volume, glm::vec3 pos);
...
private:
  glm::dvec4 C_Riemann (vr::Volume *volume, glm::vec3 minpos, glm::vec3 maxpos);
  glm::dvec4 C_RiemannWithExpCalc (vr::Volume *volume, glm::vec3 minpos, glm::vec3 maxpos);
  glm::dvec4 C_SimpsonRule (vr::Volume *volume, glm::vec3 minpos, glm::vec3 maxpos);
  
  glm::dvec4 I_Recursive_Adaptive_Simpson (vr::Volume *volume, glm::vec3 minpos, glm::vec3 maxpos);
  glm::dvec4 I_Recursive_Adaptive_Simpson_Particioned (vr::Volume *volume, glm::vec3 minpos, glm::vec3 maxpos);
  
  glm::dvec4 A_Simpson_Half_Integration (vr::Volume *volume, glm::vec3 minpos, glm::vec3 maxpos);
  glm::dvec4 A_Simpson_Error_Integration (vr::Volume *volume, glm::vec3 minpos, glm::vec3 maxpos);
  glm::dvec4 A_Simpson_Error_Projection_Integration (vr::Volume *volume, glm::vec3 minpos, glm::vec3 maxpos);
  glm::dvec4 A_Simpson_Error_Half_Projection_Integration (vr::Volume *volume, glm::vec3 minpos, glm::vec3 maxpos);

  glm::dvec4 A_Simpson_Half_Queue (vr::Volume *volume, glm::vec3 minpos, glm::vec3 maxpos);
  glm::dvec4 A_Simpson_Half_Queue_Internal_Projected (vr::Volume *volume, glm::vec3 minpos, glm::vec3 maxpos);
  glm::dvec4 A_Simpson_Half_Queue_Iteration (vr::Volume *volume, glm::vec3 minpos, glm::vec3 maxpos);

  glm::dvec4 A_Simpson_Error_Half_Integration (vr::Volume *volume, glm::vec3 minpos, glm::vec3 maxpos);
  glm::dvec4 A_Simpson_Error_Quadratic_Integration (vr::Volume *volume, glm::vec3 minpos, glm::vec3 maxpos);

  glm::dvec4 A_Simpson_Half_Iterate_Riemann_Error (vr::Volume *volume, glm::vec3 minpos, glm::vec3 maxpos);
  glm::dvec4 A_Simpson_Half_Iterate (vr::Volume *volume, glm::vec3 minpos, glm::vec3 maxpos);
  glm::dvec4 VolEval_AdaptiveSimpsonCoupled (vr::Volume *volume, glm::vec3 minpos, glm::vec3 maxpos);
  glm::dvec4 A_Simpson_Half_Iterate_Simple_ExtStep (vr::Volume *volume, glm::vec3 minpos, glm::vec3 maxpos);
  glm::dvec4 A_Simpson_Half_Iterate_Complex_ExtStep (vr::Volume *volume, glm::vec3 minpos, glm::vec3 maxpos);
  glm::dvec4 A_Simpson_Half_Iterate_Exp (vr::Volume *volume, glm::vec3 minpos, glm::vec3 maxpos);
  glm::dvec4 A_Simpson_Half_Iterate_Separated (vr::Volume *volume, glm::vec3 minpos, glm::vec3 maxpos);
  glm::dvec4 VolEval_AdaptiveSimpsonDecoupled (vr::Volume *volume, glm::vec3 minpos, glm::vec3 maxpos);

  glm::dvec4 E_Tests (vr::Volume *volume, glm::vec3 minpos, glm::vec3 maxpos, void* data = NULL);
