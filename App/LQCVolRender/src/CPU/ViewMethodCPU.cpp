...
glm::vec4 pixelerror;
err_type* gt_pixels;
void ViewMethodCPU::RenderErrorTest (CPUTimer* timeclock, glm::vec4* accumerror, glm::vec4* maxerror)
{
...
void ViewMethodCPU::ErrorTests ()
{
	...
	glm::vec4 R___1_000_accumerror (0), R___1_000_maxerror (0);
	CPUTimer R___0_500_timeclock;
	glm::vec4 R___0_500_accumerror (0), R___0_500_maxerror (0);
	CPUTimer R___0_100_timeclock;
	glm::vec4 R___0_100_accumerror (0), R___0_100_maxerror (0);
	CPUTimer R___0_050_timeclock;
	glm::vec4 R___0_050_accumerror (0), R___0_050_maxerror (0);


	CPUTimer Sh__0_100_timeclock;
	glm::vec4 Sh__0_100_accumerror (0), Sh__0_100_maxerror (0);
	CPUTimer Sh__0_010_timeclock;
	glm::vec4 Sh__0_010_accumerror (0), Sh__0_010_maxerror (0);

	CPUTimer Se__0_100_timeclock;
	glm::vec4 Se__0_100_accumerror (0), Se__0_100_maxerror (0);
	CPUTimer Se__0_010_timeclock;
	glm::vec4 Se__0_010_accumerror (0), Se__0_010_maxerror (0);
	CPUTimer Se__0_001_timeclock;
	glm::vec4 Se__0_001_accumerror (0), Se__0_001_maxerror (0);
	
	CPUTimer Sep_0_100_timeclock;
	glm::vec4 Sep_0_100_accumerror (0), Sep_0_100_maxerror (0);
	CPUTimer Sep_0_010_timeclock;
	glm::vec4 Sep_0_010_accumerror (0), Sep_0_010_maxerror (0);
	CPUTimer Sep_0_001_timeclock;
	glm::vec4 Sep_0_001_accumerror (0), Sep_0_001_maxerror (0);

	CPUTimer Seq_0_100_timeclock;
	glm::vec4 Seq_0_100_accumerror (0), Seq_0_100_maxerror (0);
	CPUTimer Seq_0_010_timeclock;
	glm::vec4 Seq_0_010_accumerror (0), Seq_0_010_maxerror (0);
	CPUTimer Seq_0_005_timeclock;
	glm::vec4 Seq_0_005_accumerror (0), Seq_0_005_maxerror (0);
	CPUTimer Seq_0_001_timeclock;
	glm::vec4 Seq_0_001_accumerror (0), Seq_0_001_maxerror (0);
	////////////////////////////////////////////////////////////////////
	////////////////////////////////////////////////////////////////////
