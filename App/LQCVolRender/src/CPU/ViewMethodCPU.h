...
class ViewMethodCPU : public ViewMethod
{
public:
  /*! Constructor*/
  ViewMethodCPU ();
...
private:
  ...
  err_type* GetErrorFromVolEvalMethod2(err_type* GroundTruth, std::string feedback_message, err_type* maxerror);
  ...
  void GenerateExtrapolatedError2(err_type* GroundTruth, char* filename, err_type* p_colors, float error);
  ...
  void RenderErrorTest (CPUTimer* timeclock, glm::vec4* accumerror, glm::vec4* maxerror);
  ...
  RendererCPU m_viewer;
  UserInterfaceCPU m_gui;
};
