...
bool VolumeEvaluator::EvaluateIntegral (glm::dvec4 *returncolor, vr::Volume *volume, glm::vec3 minpos, glm::vec3 maxpos, void* data)
{
...
float VolumeEvaluator::GetValueFromVolume (vr::Volume* volume, glm::vec3 pos)
{
#ifdef STATISTICS_GETS
  m_statistics.n_gets_volume_values++;
#endif
...
glm::dvec4 VolumeEvaluator::C_Riemann (vr::Volume *volume, glm::vec3 minpos, glm::vec3 maxpos)
{
  glm::dvec4 color (0);
  ...
  double s1 = glm::distance (minpos, maxpos);
  double s0 = 0;
...
glm::dvec4 VolumeEvaluator::C_RiemannWithExpCalc (vr::Volume *volume, glm::vec3 minpos, glm::vec3 maxpos)
{
  glm::dvec4 color (0);
  glm::dvec3 step = glm::normalize (glm::dvec3 (maxpos.x, maxpos.y, maxpos.z) - glm::dvec3 (minpos.x, minpos.y, minpos.z));
  glm::dvec3 dminpos = glm::dvec3 (minpos.x, minpos.y, minpos.z);
...
glm::dvec4 VolumeEvaluator::C_SimpsonRule (vr::Volume *volume, glm::vec3 minpos, glm::vec3 maxpos)
{
  glm::dvec4 color (0);
  glm::dvec3 step = glm::normalize (glm::dvec3 (maxpos.x, maxpos.y, maxpos.z) - glm::dvec3 (minpos.x, minpos.y, minpos.z));
  glm::dvec3 dminpos = glm::dvec3 (minpos.x, minpos.y, minpos.z);
  ...
  glm::dvec4 tf_b = TransferFunction (GetValueFromVolume (volume, glm::vec3 (p3.x, p3.y, p3.z)));
  ...
  while (s < s1)
  {
    ...
    tf_a = tf_b;
    tf_c = TransferFunction (GetValueFromVolume (volume, glm::vec3 (p2.x, p2.y, p2.z)));
    tf_b = TransferFunction (GetValueFromVolume (volume, glm::vec3 (p3.x, p3.y, p3.z)));
    tf_d = TransferFunction (GetValueFromVolume (volume, glm::vec3 ((p1.x + p2.x) * 0.5, (p1.y + p2.y) * 0.5, (p1.z + p2.z) * 0.5)));
    tf_e = TransferFunction (GetValueFromVolume (volume, glm::vec3 ((p3.x + p2.x) * 0.5, (p3.y + p2.y) * 0.5, (p3.z + p2.z) * 0.5)));
...
glm::dvec4 VolumeEvaluator::I_Recursive_Adaptive_Simpson (vr::Volume *volume, glm::vec3 minpos, glm::vec3 maxpos)
{
  ...
  a_spe.RunEvaluation (0, glm::distance (minpos, maxpos));
...
glm::dvec4 VolumeEvaluator::I_Recursive_Adaptive_Simpson_Particioned (vr::Volume *volume, glm::vec3 minpos, glm::vec3 maxpos)
{
  a_spe.SetParameters (AdaptiveSimpsonParticionedEvaluator::Parameters (
    m_integral_error, m_error_inner_integral, m_adaptive_distance_intervals, 
    m_adaptive_simpson_max_depth, volume, m_transfer_function, this));
...
glm::dvec4 VolumeEvaluator::A_Simpson_Half_Integration (vr::Volume *volume, glm::vec3 minpos, glm::vec3 maxpos)
{
...
glm::dvec4 VolumeEvaluator::A_Simpson_Error_Integration (vr::Volume *volume, glm::vec3 minpos, glm::vec3 maxpos)
{
...
glm::dvec4 VolumeEvaluator::A_Simpson_Error_Projection_Integration (vr::Volume *volume, glm::vec3 minpos, glm::vec3 maxpos)
{
...
glm::dvec4 VolumeEvaluator::A_Simpson_Error_Half_Projection_Integration (vr::Volume *volume, glm::vec3 minpos, glm::vec3 maxpos)
{
...
glm::dvec4 VolumeEvaluator::A_Simpson_Half_Queue (vr::Volume *volume, glm::vec3 minpos, glm::vec3 maxpos)
{
...
glm::dvec4 VolumeEvaluator::A_Simpson_Half_Queue_Internal_Projected (vr::Volume *volume, glm::vec3 minpos, glm::vec3 maxpos)
{
  a_shqi.Init (glm::dvec3 (minpos.x, minpos.y, minpos.z), glm::dvec3 (maxpos.x, maxpos.y, maxpos.z), m_volume, m_transfer_function);
  double s1 = glm::distance (minpos, maxpos);
...
glm::dvec4 VolumeEvaluator::A_Simpson_Half_Queue_Iteration (vr::Volume *volume, glm::vec3 minpos, glm::vec3 maxpos)
{
  a_shqi.Init (glm::dvec3 (minpos.x, minpos.y, minpos.z), glm::dvec3 (maxpos.x, maxpos.y, maxpos.z), m_volume, m_transfer_function);
  double s1 = glm::distance (minpos, maxpos);
...
glm::dvec4 VolumeEvaluator::A_Simpson_Error_Half_Integration (vr::Volume *volume, glm::vec3 minpos, glm::vec3 maxpos)
{
...
glm::dvec4 VolumeEvaluator::A_Simpson_Error_Quadratic_Integration (vr::Volume *volume, glm::vec3 minpos, glm::vec3 maxpos)
{
...
glm::dvec4 VolumeEvaluator::A_Simpson_Half_Iterate_Riemann_Error (vr::Volume *volume, glm::vec3 minpos, glm::vec3 maxpos)
{
...
glm::dvec4 VolumeEvaluator::A_Simpson_Half_Iterate (vr::Volume *volume, glm::vec3 minpos, glm::vec3 maxpos)
{
...
glm::dvec4 VolumeEvaluator::VolEval_AdaptiveSimpsonCoupled (vr::Volume *volume, glm::vec3 minpos, glm::vec3 maxpos)
{
...
glm::dvec4 VolumeEvaluator::A_Simpson_Half_Iterate_Simple_ExtStep (vr::Volume *volume, glm::vec3 minpos, glm::vec3 maxpos)
{
  a_shii.Init (glm::dvec3 (minpos.x, minpos.y, minpos.z), glm::dvec3 (maxpos.x, maxpos.y, maxpos.z), m_volume, m_transfer_function);
  double s1 = glm::distance (minpos, maxpos);
...
glm::dvec4 VolumeEvaluator::A_Simpson_Half_Iterate_Complex_ExtStep (vr::Volume *volume, glm::vec3 minpos, glm::vec3 maxpos)
{
  a_shii.Init (glm::dvec3 (minpos.x, minpos.y, minpos.z), glm::dvec3 (maxpos.x, maxpos.y, maxpos.z), m_volume, m_transfer_function);
  double s1 = glm::distance (minpos, maxpos);
...
glm::dvec4 VolumeEvaluator::A_Simpson_Half_Iterate_Exp (vr::Volume *volume, glm::vec3 minpos, glm::vec3 maxpos)
{
  a_shii.Init (glm::dvec3 (minpos.x, minpos.y, minpos.z), glm::dvec3 (maxpos.x, maxpos.y, maxpos.z), m_volume, m_transfer_function);
  double s1 = glm::distance (minpos, maxpos);
...
glm::dvec4 VolumeEvaluator::A_Simpson_Half_Iterate_Separated (vr::Volume *volume, glm::vec3 minpos, glm::vec3 maxpos)
{
  a_shii.Init (glm::dvec3 (minpos.x, minpos.y, minpos.z), glm::dvec3 (maxpos.x, maxpos.y, maxpos.z), m_volume, m_transfer_function);
  double s1 = glm::distance (minpos, maxpos);
...
glm::dvec4 VolumeEvaluator::VolEval_AdaptiveSimpsonDecoupled (vr::Volume *volume, glm::vec3 minpos, glm::vec3 maxpos)
{
  a_shii.Init (glm::dvec3 (minpos.x, minpos.y, minpos.z), glm::dvec3 (maxpos.x, maxpos.y, maxpos.z), m_volume, m_transfer_function);
  double s1 = glm::distance (minpos, maxpos);
...
glm::dvec4 VolumeEvaluator::E_Tests (vr::Volume *volume, glm::vec3 minpos, glm::vec3 maxpos, void* data)
{
  glm::dvec3 step = glm::normalize (glm::dvec3 (maxpos.x, maxpos.y, maxpos.z) - glm::dvec3 (minpos.x, minpos.y, minpos.z));
  glm::dvec3 dminpos = glm::dvec3 (minpos.x, minpos.y, minpos.z);
