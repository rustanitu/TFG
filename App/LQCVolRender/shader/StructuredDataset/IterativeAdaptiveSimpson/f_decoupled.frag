...
void main()
{
  ...
  float hext, hint, hproj;
  hext = initial_step; hint = initial_step; hproj = initial_step;
  ...
  while (s1 > anchor)
  {
    ...
    //Integral Interna
    {
      hint = min (min (hproj, hmax), s1 - anchor);
