...
#ifndef ADAPTIVE_GLSL_VIEWMETHOD_H
#define ADAPTIVE_GLSL_VIEWMETHOD_H
...
class ViewMethodAdaptive : public GLSLViewMethod
{
public:
  /*! Constructor
  */
...
private:
  ...
  RendererAdaptive m_renderer;
  UserInterfaceAdaptive m_gui;
};
