...
int CPUViewMethod::Idle_Action_CB (Ihandle* cnv_renderer)
{
...
int CPUViewMethod::Keyboard_CB (Ihandle *ih, int c, int press)
{
  if (press == 0)
  {
    switch (c)
...
int CPUViewMethod::Button_CB (Ihandle* ih, int button, int pressed, int x, int y, char* status)
{
...
int CPUViewMethod::Motion_CB (Ihandle *ih, int x, int y, char *status)
{
  return IUP_DEFAULT;
}

int CPUViewMethod::Resize_CB (Ihandle *ih, int width, int height)
{
  Resize (width, height);
  return IUP_DEFAULT;
}

void CPUViewMethod::CreateIupUserInterface ()
{
  m_gui.CreateIupInterface ();
}

void CPUViewMethod::UpdateIupUserInterface ()
{
...
void CPUViewMethod::ResetCamera ()
{
  m_viewer.ResetCamera (Viewer::Instance ()->m_CurrentWidth, Viewer::Instance ()->m_CurrentHeight);
  m_redisplay = true;
}

void CPUViewMethod::BuildViewer ()
{
  if (!m_built)
  {
...
void CPUViewMethod::CleanViewer ()
{
  if (m_built)
  {
...
void CPUViewMethod::SetPThread (bool state)
{
  m_viewer.m_pthread_on = state;
}

bool CPUViewMethod::IsUsingPThread ()
{
  return m_viewer.m_pthread_on;
}

void CPUViewMethod::SetCurrentMethod (int item)
{
  m_viewer.m_voleval.m_current_method = item;
}

void CPUViewMethod::SetSamples (int samples)
{
  if (samples >= 1)
    m_viewer.m_voleval.m_samples = samples;
}

int CPUViewMethod::GetSamples ()
{
  return m_viewer.m_voleval.m_samples;
}

void CPUViewMethod::SetAdaptiveSamples (int adap_samples)
{
  if (adap_samples >= 1)
    m_viewer.m_voleval.m_adaptive_samples = adap_samples;
}

int CPUViewMethod::GetAdaptiveSamples ()
{
  return m_viewer.m_voleval.m_adaptive_samples;
}

void CPUViewMethod::SetIntegralError (double error)
{
  m_viewer.m_voleval.m_integral_error = error;
  m_gui.SetErrorValue (error);
}

double CPUViewMethod::GetIntegralError ()
{
  return m_viewer.m_voleval.m_integral_error;
}

void CPUViewMethod::SetInnerIntegralError (double error)
{
  m_viewer.m_voleval.m_error_inner_integral = error;
}

double CPUViewMethod::GetInnerIntegralError ()
{
  return m_viewer.m_voleval.m_error_inner_integral;
}

void CPUViewMethod::SetIntervalDistance (double distance)
{
  m_viewer.m_voleval.m_adaptive_distance_intervals = distance;
}

double CPUViewMethod::GetIntervalDistance ()
{
  return m_viewer.m_voleval.m_adaptive_distance_intervals;
}

double CPUViewMethod::GetMinError ()
{
  return m_gui.GetMinError ();
}

double CPUViewMethod::GetMaxError ()
{
  return m_gui.GetMaxError ();
}

void CPUViewMethod::Resize (int width, int height)
{
  m_canvaswidth = width;
...
int CPUViewMethod::GetNumberOfThreads ()
{
  return m_viewer.m_num_of_threads;
}

void CPUViewMethod::SetNumberOfThreads (int nthreads)
{
  if (nthreads == 2 || nthreads == 4)
    m_viewer.m_num_of_threads = nthreads;
}

void CPUViewMethod::SetUseAlphaTruncation (bool state)
{
  m_viewer.m_voleval.m_alpha_truncation = state;
}

bool CPUViewMethod::IsUsingAlphaTruncation ()
{
  return m_viewer.m_voleval.m_alpha_truncation;
}

VolumeEvaluator* CPUViewMethod::GetVolumeEvaluator ()
{
  return &m_viewer.m_voleval;
}

void CPUViewMethod::RecalculateAABBSizes ()
{
...
err_type* gt_pixels;
void CPUViewMethod::RenderErrorTest (CPUTimer* timeclock, lqc::Vector4f* accumerror, lqc::Vector4f* maxerror)
{
...
void CPUViewMethod::SaveCameraState (std::string filename)
{
  m_viewer.SaveInitRtCameraState (filename);
}

void CPUViewMethod::LoadCameraState (std::string filename)
{
  m_viewer.LoadInitRtCameraState (filename);
}

void CPUViewMethod::MapErrorTests ()
{
...
void CPUViewMethod::GenerateErrorMap (char* filename, char* filename_alpha, err_type* gt_pixels, int width, int height)
{
  Ihandle* cnv = Viewer::Instance ()->GetCanvasRenderer ();
  IupGLMakeCurrent (cnv);
...
void CPUViewMethod::HistogramGeneration ()
{
  ...
  //Viewer::Instance ()->GenerateVolHistogram();
  ...
  //m_viewer.m_voleval.m_current_method = VolumeEvaluator::C_SIMPSON_RULE;
  ////RIEMANN
  //m_viewer.m_voleval.m_distance_intervals = 0.5;
  //err_type* s05_error = GetErrorFromVolEvalMethod (gt_pixels, "Simpson 0.5", maxerror);
  //m_viewer.m_voleval.m_distance_intervals = 0.4;
  //err_type* s04_error = GetErrorFromVolEvalMethod (gt_pixels, "Simpson 0.4", maxerror);
  //m_viewer.m_voleval.m_distance_intervals = 0.3;
  //err_type* s03_error = GetErrorFromVolEvalMethod (gt_pixels, "Simpson 0.3", maxerror);
  //m_viewer.m_voleval.m_distance_intervals = 0.2;
  //err_type* s02_error = GetErrorFromVolEvalMethod (gt_pixels, "Simpson 0.2", maxerror);
  //m_viewer.m_voleval.m_distance_intervals = 0.1;
  //err_type* s01_error = GetErrorFromVolEvalMethod (gt_pixels, "Simpson 0.1", maxerror);
  ...
  //GenerateExtrapolatedError ("0010_Simpson_05.txt", s05_error, 0.010);
  //GenerateExtrapolatedError ("0010_Simpson_04.txt", s04_error, 0.010);
  //GenerateExtrapolatedError ("0010_Simpson_03.txt", s03_error, 0.010);
  //GenerateExtrapolatedError ("0010_Simpson_02.txt", s02_error, 0.010);
  //GenerateExtrapolatedError ("0010_Simpson_01.txt", s01_error, 0.010);
  GenerateExtrapolatedError ("0010_OptimizedAdaptive.txt"        , opt_0010    , 0.010);
  GenerateExtrapolatedError ("0010_SeparatedAdaptiveOptmized.txt", sep_opt_0010, 0.010);
  ...
  //GenerateExtrapolatedError ("0005_Simpson_05.txt", s05_error, 0.005);
  //GenerateExtrapolatedError ("0005_Simpson_04.txt", s04_error, 0.005);
  //GenerateExtrapolatedError ("0005_Simpson_03.txt", s03_error, 0.005);
  //GenerateExtrapolatedError ("0005_Simpson_02.txt", s02_error, 0.005);
  //GenerateExtrapolatedError ("0005_Simpson_01.txt", s01_error, 0.005);
  GenerateExtrapolatedError ("0005_OptimizedAdaptive.txt"        , opt_0005    , 0.005);
  GenerateExtrapolatedError ("0005_SeparatedAdaptiveOptmized.txt", sep_opt_0005, 0.005);
  ...
  //GenerateExtrapolatedError ("0001_Simpson_05.txt", s05_error, 0.001);
  //GenerateExtrapolatedError ("0001_Simpson_04.txt", s04_error, 0.001);
  //GenerateExtrapolatedError ("0001_Simpson_03.txt", s03_error, 0.001);
  //GenerateExtrapolatedError ("0001_Simpson_02.txt", s02_error, 0.001);
  //GenerateExtrapolatedError ("0001_Simpson_01.txt", s01_error, 0.001);
  GenerateExtrapolatedError ("0001_OptimizedAdaptive.txt"        , opt_0001    , 0.001);
  GenerateExtrapolatedError ("0001_SeparatedAdaptiveOptmized.txt", sep_opt_0001, 0.001);
...
void CPUViewMethod::GenerateHistogramError (std::string filename, err_type* p_errors)
{
...
void CPUViewMethod::StepChangeSimpsonTest ()
{
...
err_type* CPUViewMethod::RenderGroundTruth ()
{
  int curmethod = m_viewer.m_voleval.m_current_method;
...
err_type* CPUViewMethod::GetErrorFromVolEvalMethod (err_type* GroundTruth, std::string feedback_message, err_type* maxerror)
{
  ...
  for (int x = 0; x < Viewer::Instance ()->m_CurrentWidth; x++)
    ...
    {
      int index = x * 4 + y*wt * 4;
      method_error[index + 0] = fabs ((err_type)m_viewer.m_pixels[index + 0] - gt_pixels[index + 0]);
      method_error[index + 1] = fabs ((err_type)m_viewer.m_pixels[index + 1] - gt_pixels[index + 1]);
      method_error[index + 2] = fabs ((err_type)m_viewer.m_pixels[index + 2] - gt_pixels[index + 2]);
      method_error[index + 3] = fabs ((err_type)m_viewer.m_pixels[index + 3] - gt_pixels[index + 3]);
...
void CPUViewMethod::GetTimeFromVolEvalMethod (std::string feedback_message)
{
  CPUTimer method_timer;
  method_timer.start ();
  m_viewer.Render (Viewer::Instance ()->m_CurrentWidth, Viewer::Instance ()->m_CurrentHeight);
...
void CPUViewMethod::GenerateHistogramErrorControlled (std::string filename, err_type* p_errors)
{
  std::fstream histogram;
  histogram.open (filename, std::ios::in | std::ios::out | std::ios::app);
  int wt = Viewer::Instance ()->m_CurrentWidth;
...
void CPUViewMethod::GenerateExtrapolatedError (std::string filename, err_type* p_errors, float error)
{
  std::fstream histogram;
  histogram.open (filename, std::ios::in | std::ios::out | std::ios::app);
  int wt = Viewer::Instance ()->m_CurrentWidth;
...
void CPUViewMethod::RunMethod (std::string feedback_message)
{
  CPUTimer method_timer;
  method_timer.start ();
  m_viewer.Render (Viewer::Instance ()->m_CurrentWidth, Viewer::Instance ()->m_CurrentHeight);
...
void CPUViewMethod::TimeGeneration ()
{
...
void CPUViewMethod::HistogramGeneration_minmax ()
{
  std::cout << "Geracao de histogramas" << std::endl;
  int curmethod = m_viewer.m_voleval.m_current_method;
  int distintervals = m_viewer.m_voleval.m_distance_intervals;
...
void CPUViewMethod::RiemannComparison ()
{
...
err_type* CPUViewMethod::RenderAndComparison (err_type* GroundTruth, std::string feedback_message, float* pixelcolor)
{
  err_type* method_error = new err_type[Viewer::Instance ()->m_CurrentWidth * Viewer::Instance ()->m_CurrentHeight * 4];
