/*!
\file SimpsonErrorIntegration.h
\brief Simpson Integrator based on error value
\author Leonardo Quatrin Campagnolo
*/

#ifndef SIMPSONERRORINTEGRATOR_H
#define SIMPSONERRORINTEGRATOR_H
...
class AdaptiveSimpsonErrorIntegrator
{
public:
...
public:
  AdaptiveSimpsonErrorIntegrator (lqc::Vector3d minp, lqc::Vector3d maxp, VolumeEvaluator* veva,
                             vr::Volume* vol, vr::TransferFunction* tf);
  ~AdaptiveSimpsonErrorIntegrator ();
...
private:
  ...
  lqc::Vector4d external_left_error_evaluated;
  lqc::Vector4d external_right_error_evaluated;
};
